...
from langchain.chat_models import ChatAnthropic, ChatCohere, ChatGooglePalm, ChatOpenAI, AzureChatOpenAI
        ...
        **kwargs: Any
        ...
        if model_family == "azure":
            return AzureChatOpenAI(
                deployment_name=self.deployment_name,model_name=model_name, openai_api_key=api_key, **kwargs
            )
